...
<div class="container">
  ...
  $sql = "SELECT IDproducto, Nombre, Descripcion, Precio, Proveedor FROM productos WHERE IDproducto=$idprod";
  ...
  if (mysqli_num_rows($result) > 0) {
    // output data of each row
      echo "<li class=\"table-header\">";
          ...
          echo "<div class=\"col col-2\" >UBICACION</div>";
          echo "<div class=\"col col-3\" >PRECIO gasolina regular</div>";
          echo "<div class=\"col col-2\" >PRECIO gasolina premium</div>";
          echo "</li>";
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<div class=\"col col-2\" data-label=\"NOMBRE\">" . $row["Descripcion"] . "</div>";
        echo "<div class=\"col col-3\" data-label=\"PRECIO\">" . $row["Precio"] . "</div>";
        echo "<div class=\"col col-2\" data-label=\"NOMBRE\">" . $row["Proveedor"] . "</div>";
        echo "</li>";
    }
    echo "</ul>"; 

  } else {
    echo "<br><h2>Producto NO existente.</h2><br>";
  }
